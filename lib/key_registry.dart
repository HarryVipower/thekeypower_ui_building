...
import 'ViewSpecificKeys.dart';
import 'allKeys_model.dart';
import 'header_footer.dart';
import 'homepage.dart';
import 'login.dart';

class KeyRegistryPage extends StatefulWidget {
  const KeyRegistryPage({super.key, required this.title,});
  final String title;

  @override
  State<KeyRegistryPage> createState() => _KeyRegistryPageState();
}

class _KeyRegistryPageState extends State<KeyRegistryPage> with SingleTickerProviderStateMixin {
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Align(
                      ...
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Flexible(flex: 1, child: Text(key.tag!, style: const TextStyle(color: Colors.white, fontSize: 16), overflow: TextOverflow.ellipsis,)),
              ...
              children: [
                Flexible(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Available:', style: headerStyle, overflow: TextOverflow.ellipsis,),
                      Text('available count here', style: contentStyle, overflow: TextOverflow.ellipsis,),
                    ],
                  ),
                ),
                ...
                Flexible(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Total:', style: headerStyle, overflow: TextOverflow.ellipsis,),
                      Text('total count here', style: contentStyle, overflow: TextOverflow.ellipsis,),
                    ],
                  ),
                )
              ],
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const ViewSpecificKeys(title: 'Title')),
                    );
                  },
        ...
        child: ListView(
          ...
          children: [
            ...
            Padding(
                ...
                child: Column(
                  children: [
                    Text('There are \$count keys registered at $buildingName.', style: const TextStyle(color: Colors.black38), textAlign: TextAlign.center,),
                    searchBar(),
                    const Divider(),
